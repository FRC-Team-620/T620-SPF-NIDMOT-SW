...
public class ShootWithVision extends Command {
    ...
    public void initialize() {
        ...
        double minBallVelocity = Math.sqrt(9.81*(Math.sqrt(Math.pow(distFromHub, 2) + Math.pow(1.83-ShooterConstants.robotHeightM, 2)) + 1.83 - ShooterConstants.robotHeightM));
